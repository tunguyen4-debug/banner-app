...
"[project]/src/app/api/generate-design/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        const { urlInfo, concept, promptOverrides, mode = "both", companyInfo } = await request.json();
        ...
        if (mode === "code" || mode === "both") {
            ...
            await delay(800);
            try {
                const htmlResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aiClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateHtmlLayout"])(finalPrompt, concept, companyInfo);
        ...
        thinkingSteps.push({
            ...
            timestamp: Date.now() - startTime,
            content: result.imageUrl ? "Banner image and code ready for preview" : result.htmlLayout ? "HTML/CSS code ready (image generation skipped or failed)" : "Generation completed but no output available"
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00258505._.js.map